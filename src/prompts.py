...
- 用户查询"某某股票分析""某某股票报告"等综合分析 → 按顺序：先 stock_agent，再 analysis_agent，再 esg_agent，再 news_agent，最后 FINISH
...
- 如果是综合分析请求（含"分析""报告""诊断"等关键词 + 股票名/代码），必须依次调用 stock_agent、analysis_agent、esg_agent、news_agent，最后 FINISH
